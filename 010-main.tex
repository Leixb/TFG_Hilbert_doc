...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \include{060-initial-seq}
    \include{060-convergence-analysis}
    \include{090-metrics}
    \include{070-initial-cuda}
    \include{075-results}


    \include{080-performance-analysis}


    \include{100-stiffness-compact}

    \include{110-julia}

    \include{120-final-benchmarks}

    \include{130-conclusions}

    \include{140-further-work}
