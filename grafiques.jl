...
# ╔═╡ 6c8eff04-fa23-48eb-b5b5-a02cb36f6efc
begin
	
	data_euler = [1 0.926208 0.148800 
2 1.016512 0.280800 
4 1.053408 0.329472 
8 1.091744 0.331200 
16 1.186976 0.452480 
32 1.177120 0.450656 
64 1.243904 0.495680 
128 1.231520 0.488768 
256 1.766496 0.955584 
512 5.333088 3.589824 
1024 19.299393 13.785568 
2048 74.058815 53.703136 
4096 293.710449 214.300903 
8192 1147.264893 835.202576 ]
		
	data_midpoint = [1 0.963136 0.195136 
	2 1.132960 0.392416 
	4 1.198528 0.458784 
	8 1.200032 0.465920 
	16 1.360064 0.630784 
	32 1.429920 0.702048 
	64 1.417984 0.685856 
	128 1.588160 0.813472 
	256 2.684704 1.840448 
	512 7.844224 6.115616 
	1024 28.331968 22.765921 
	2048 113.633629 88.153984 
	4096 398.023956 319.354218 
	8192 1585.228027 1274.599243]
	
	data_rk3 = [1 1.121760 0.349600 
	2 1.447424 0.714944 
	4 1.599200 0.844800 
	8 1.590752 0.856448 
	16 1.893280 1.158464 
	32 1.922592 1.166304 
	64 1.988608 1.236096 
	128 2.220320 1.470432 
	256 4.765760 3.964608 
	512 15.368416 13.628800 
	1024 56.539360 51.099106 
	2048 214.941345 194.475494 
	4096 802.318054 723.833069 
	8192 3196.370605 2886.863770 ]
...
4 1.383232 0.653088 
8 1.417120 0.694304 
16 1.577760 0.863040 
32 1.793888 1.068992 
64 1.847776 1.120064 
128 4.567968 3.814272 
256 5.046976 4.223040 
512 37.812386 36.080383 
1024 53.458336 47.926750 
2048 91.969566 71.588257 
4096 227.059067 148.281311 
8192 843.364502 534.837219
		]
	
	data_rk45 = [
		1 12.800256 12.011936 
2 12.790976 12.024352 
4 12.872064 12.131488 
8 13.157568 12.431648 
16 15.057056 14.329472 
32 18.029312 17.303583 
64 19.459743 18.711361 
128 20.558016 19.801249 
256 30.318720 29.508640 
512 55.825760 54.091808 
1024 179.047363 173.275650 
2048 575.183838 554.710327 
4096 2179.337891 2099.932861 
8192 8444.505859 8132.761719
		]
	...
	4 1.508224 0.774720 
	8 1.523232 0.801856 
	16 1.874848 1.096480 
	32 1.859424 1.125088 
	64 1.900128 1.175808 
	128 2.365856 1.616352 
	256 5.527136 4.689248 
	512 16.582081 14.873856 
	1024 61.870720 56.415550 
	2048 242.607941 222.035034 
	4096 963.028992 883.877991 
	8192 3842.293213 3529.613037
		]
end

# ╔═╡ 6fc13712-4f26-43e4-8768-aeebcb163e82
begin
	steps_methods = data_rk4[:,1]
	time_rk4 = data_rk4[:,2]
	time_rk3 = data_rk3[:,2]
	time_mdp = data_midpoint[:,2]
	time_eul = data_euler[:,2]
	
	time_rk23 = data_rk23[:,2]
	time_rk45 = data_rk45[:,2]
end

# ╔═╡ 1ddd7487-9b4c-4408-b3d1-422171276348
plot_methods = let
	plot(
		xlabel="Grid size",
		ylabel="Time (ms)",
		xscale=:log2,
		yscale=:log10,
		xticks=(steps_methods, ["2^{$i}" for i in 2 .*Int.(log2.(steps_methods))])
	)
	scatter!(steps_methods, time_eul, label="Euler")
	scatter!(steps_methods, time_mdp, label="Midpoint")
	scatter!(steps_methods, time_rk3, label="RK3")
	scatter!(steps_methods, time_rk4, label="RK4")
	
	#scatter!(steps_methods, time_rk23, label="RK23")
	scatter!(steps_methods, time_rk45, label="RK4(5)", markershape=:diamond)
end

# ╔═╡ 57ac931d-d619-4b22-8bb0-92395f7fe735
time_seq_ext./time_eul
